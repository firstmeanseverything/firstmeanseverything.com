    ...
    <div className="px-4 py-8">
      <div className="prose mx-auto">
        ...
        <p>
          ...
          using any other services provided by First Means Everything Ltd.
        </p>
        <p>
          We, First Means Everything Ltd, reserve the right to review and amend
        ...
        <ol>
          ...
          <li>
            ...
            service First Means Everything Ltd provides;
          </li>
          <li>
        ...
        <p>
          ...
          restrictions or the Terms of Service, and may be terminated by First
          Means Everything Ltd at any time.
        </p>
        ...
        <p>
          ...
          is' basis. To the extent permitted by law, First Means Everything Ltd
        ...
        <p>
          ...
          an authorised representative has been notified, orally or in writing,
        ...
        <p>
          ...
          for general information purposes only. First Means Everything Ltd does
        ...
        <h2>Links</h2>
        <p>
          First Means Everything Ltd has not reviewed all of the sites linked to
          ...
          or control by First Means Everything Ltd of the site. Use of any such
