  ...
  return (
    <div className="px-4 py-8">
      <div className="prose mx-auto">
        ...
        <p>This policy is effective as of 4 April 2021.</p>
        <p>
          Last updated: <strong>4 April 2021</strong>
        </p>
        ...
        <p>
          ...
          processors&rdquo;). We, First Means Everything Ltd, located at the
        ...
        <p>
          ...
          account, we will delete your personal information within 14 days of
